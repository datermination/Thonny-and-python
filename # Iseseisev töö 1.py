...
alus = float(input("Sisesta aluse kõrgus: "))
if alus < 2:
    print("on alumine kiht")
...
# Pilve aluse kõrgus 7.5
# sisestatu üle 6,0 km
# kui kõrgus on 6,0km või alla selle
# alumisel pilvedel on madalamal kui 2km
